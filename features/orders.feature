Feature: The order store service back-end
    ...
    Scenario: Cannot update an order with invalid date format
        When I visit the "Home Page"
        And I set the "Customer_id" to "92931"
        And I press the "Search" button
        Then I should see the message "Success"
        ...
        And I press the "Update" button
        Then I should see the message "Invalid date, date should be valid and in yyyy-mm-dd format"
